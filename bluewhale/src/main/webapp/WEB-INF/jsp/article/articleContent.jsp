...
<body>
  ...
  <!-- Page Header -->
  <header class="masthead" style="background-image: url('/bluewhale/img/baseLayout/post-bg.jpg')">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          ...
          <a href="#">
            <img class="img-fluid" src="/bluewhale/img/baseLayout/post-sample-image.jpg" alt="">
          </a>
