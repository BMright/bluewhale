...
<body>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item" id="search">
		   ...
		   <li class="nav-item">
            <a class="nav-link" href="/bluewhale/visitor">首页</a>
          </li>
          <li class="nav-item">
  ...
  <!-- Page Header -->
  <header class="masthead" style="background-image: url('/bluewhale/img/baseLayout/main-bg.jpg');height: 70px;">
   ...
   <div class="container" id="blogs">
    <div class="row">
      <div class="col-lg-12 col-md-12 mx-auto">
      	...
      	<a href="blog_context.html" class="card border-success col-lg-3 col-md-3 mx-auto mb-3" id="small_blog" data-aos="zoom-in" style="max-width: 16rem;">
