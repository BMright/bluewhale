...
<body>
 ...
 <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
  ...
  <div class="col-lg-10 col-md-10 mx-auto">
	 ...
	 <div class="container" id="my_notes">
	     <div class="row">
	       <div class="col-lg-12 col-md-12 mx-auto">
	       	...
	       	<div class="card col-lg-10 col-md-10 mx-auto" id="each_note" data-aos="flip-right">
	       	  <div class="card-header note_head">
	       	    <a href="#"><img  src="<%=basePath%>img/baseLayout/post-sample-image.jpg"  style="width: 50px;height: 50px; border-radius: 50%; cursor: pointer;" /></a>
				用户名
	       	  </div>
	       	  <div class="card-body note_body">
	       	    <p class="card-text">留言内容</p>
	       	    <button type="button" class="btn btn-primary sure_btn">回复</button>
				<button type="button" class="btn btn-primary sure_btn">删除</button>
	       	  </div>
	       	</div>
